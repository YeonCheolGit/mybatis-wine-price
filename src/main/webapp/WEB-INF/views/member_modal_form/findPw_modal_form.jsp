...
<body>
<%-- 비밀번호 찾기 모달 --%>
<div class="modal fade" id="find-pw-modal-form" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
...
<script type="text/javascript" src='${pageContext.request.contextPath}/resources/static/js/findPw.js'></script>
