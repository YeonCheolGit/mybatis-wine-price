...
<jsp:include page="../modal_form/login_modal_form.jsp" />
<jsp:include page="../modal_form/findPw_modal_form.jsp" />
<jsp:include page="../modal_form/register_modal_form.jsp" />
<jsp:include page="../modal_form/updateMember_modal_form.jsp" />
